...
function updateGithubFields(){
	...
	user_info_string += "<span> Public repos: <a href=\"https://github.com/fbufler?tab=repositories\" target=\"_blank\">" +  responseObj.public_repos +"</a></span>"
	user_info_string += "</div>"
	user_info_string += "<div>"
	user_info_string += "<i class=\"fas fa-code\"></i>"
	user_info_string += "<span> Public gists: <a href=\"https://gist.github.com/fbufler\" target=\"_blank\">" +  responseObj.public_gists +"</a></span>"
	user_info_string += "</div>"
	user_info_string += "<div>"
	user_info_string += "<i class=\"fas fa-users\"></i>"
	user_info_string += "<span> Followers: <a href=\"https://github.com/fbufler?tab=followers\" target=\"_blank\">" + responseObj.followers +"</a></span>"
	user_info_string += "<span> Following: <a href=\"https://github.com/fbufler?tab=following\" target=\"_blank\">" +  responseObj.following +"</a></span>"
...
request_basics.open('get', 'https://api.github.com/users/fbufler', true)
request_basics.send()

var request_repos = new XMLHttpRequest();
request_repos.onload = updateGithubRepos;
request_repos.open('get', 'https://api.github.com/users/fbufler/repos', true)
request_repos.send()
